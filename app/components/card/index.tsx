...
export default function Card({ openModal }: CardProps) {
    ...
    return (
        <div className='text-white grid grid-cols-4 gap-4 p-6 h-screen'>
            ...
            <button className='bg-while border-2 border-dashed rounded-2xl flex items-center justify-center' onClick={openModal}>新增任務<FaPlus /></button>
        </div>
    )
}